...
<head>
    ...
    <script>
        $(document).ready(function (){
            var setTotalCount = AjaxGetc('http://localhost:8080/ChatRobot/custom/searchCount', " ");
            $('#box').paging({
                initPageNo: 1, // 初始页码
...
//                        bValid = bValid && checkRegexp( rpassword, /^([0-9a-zA-Z])+$/, "密码字段只允许： a-z 0-9" );
                        if ( bValid ) {
                            ...
                            $.ajax({
                                url: "http://localhost:8080/ChatRobot/custom/addcustom",
                                type: 'post',
                                data:json,
                                async:false,
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                        ...
                        <div class="panel-body" id="dialog-form" title="创建新用户">
                            ...
                            <form action="${pageContext.request.contextPath}/custom/addSales" >
                ...
                <div class="row">
                    <div class="col-md-12">
                            <div class="form-group input-group col-md-6 col-md-offset-3">
                                <input type="text" class="form-control" placeholder="Enter Keywords" id="searchcustom" />
                                <span class="input-group-btn">
                                <input class="btn btn-primary" value="SEARCH" onclick="selectcustomPage()"  type="button "/>
                                </span>
                            </div>
                            <br/>
                    </div>
                ...
                <p>
                    <button class="btn btn-inverse" id="create-user"><i class="glyphicon glyphicon-plus"></i>ADD</button>
                    <button class="btn btn-danger" onclick="deleteAll('http://localhost:8080/ChatRobot/custom/deleteAll')"><i class="glyphicon glyphicon-home"></i>Delete</button>
                </p>
