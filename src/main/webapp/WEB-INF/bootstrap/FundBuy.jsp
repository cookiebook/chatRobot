...
<head>
    ...
    <script>
        $(document).ready(function () {
            var flag=1;
            var setTotalCount = AjaxGetF('http://localhost:8080/ChatRobot/Fund/searchCount', " ",flag);
            $('#box').paging({
                initPageNo: 1, // 初始页码
            ...
            $("#buy").click(function () {
                ...
                var postData = {"fNo":username,"cno":cno,"password":password};
                bodyRSA();
                var pwd = encryptedString(key, encodeURIComponent(JSON.stringify(postData)));
                var result = {result: pwd};
                httpPost("http://localhost:8080/ChatRobot/Fund/BuyFund",result);
            })
        })
    </script>
</head>
<body>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                            <div class="form-group input-group col-md-6 col-md-offset-3">
                                <input type="text" class="form-control" placeholder="Enter Keywords" id="searchFund" />
                                <span class="input-group-btn">
                                <input class="btn btn-primary" value="SEARCH" onclick="selectFundPage(1)"  type="button "/>
                                </span>
                            </div>
                            <br/>
                    </div>
                ...
                <p>
                    <a class="btn btn-inverse" href="http://localhost:8080/ChatRobot/bootstrap/insertFund.jsp" ><i class="glyphicon glyphicon-plus"></i>ADD</a>
                    <button class="btn btn-danger" onclick="deleteAll('http://localhost:8080/ChatRobot/Fund/InterestAll')"><i class="glyphicon glyphicon-home"></i>Interest</button>
                </p>
             <!-- /. ROW  -->
