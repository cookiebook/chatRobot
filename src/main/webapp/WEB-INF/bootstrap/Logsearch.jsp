...
<head>
    ...
    <script>
        $(document).ready(function () {
            var setTotalCount = AjaxGetL('http://localhost:8080/ChatRobot/Log/searchCount', " ");
            $('#box').paging({
                initPageNo: 1, // 初始页码
...
<body>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                            <div class="form-group input-group col-md-6 col-md-offset-3">
                                <input type="text" class="form-control" placeholder="Enter Keywords" id="searchLog" />
                                <span class="input-group-btn">
                                <input class="btn btn-primary" value="SEARCH" onclick="selectLogPage()"  type="button "/>
                                </span>
                            </div>
                            <br/>
                    </div>
                ...
                <p>
                    <a class="btn btn-inverse" href="http://localhost:8080/ChatRobot/Log/backup" ><i class="glyphicon glyphicon-plus"></i>BACK-UP</a>
                    <button class="btn btn-danger" onclick="deleteAll('http://localhost:8080/ChatRobot/Log/deleteAll')"><i class="glyphicon glyphicon-home"></i>Delete</button>
                </p>
